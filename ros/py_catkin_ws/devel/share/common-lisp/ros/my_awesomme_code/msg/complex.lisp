...
(cl:defmethod cl:initialize-instance :after ((m <complex>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'complex)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_awesomme_code-msg:<complex> is deprecated: use my_awesomme_code-msg:complex instead.")))

(cl:ensure-generic-function 'real-val :lambda-list '(m))
(cl:defmethod real-val ((m <complex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_awesomme_code-msg:real-val is deprecated.  Use my_awesomme_code-msg:real instead.")
  (real m))

(cl:ensure-generic-function 'imaginary-val :lambda-list '(m))
(cl:defmethod imaginary-val ((m <complex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_awesomme_code-msg:imaginary-val is deprecated.  Use my_awesomme_code-msg:imaginary instead.")
  (imaginary m))
