...
(cl:defmethod time_elapsed-val ((m <TimerFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_awesomme_code-msg:time_elapsed-val is deprecated.  Use my_awesomme_code-msg:time_elapsed instead.")
  (time_elapsed m))

(cl:ensure-generic-function 'time_remaining-val :lambda-list '(m))
(cl:defmethod time_remaining-val ((m <TimerFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_awesomme_code-msg:time_remaining-val is deprecated.  Use my_awesomme_code-msg:time_remaining instead.")
  (time_remaining m))
