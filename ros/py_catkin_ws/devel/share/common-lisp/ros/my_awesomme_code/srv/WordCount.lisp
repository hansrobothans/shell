...
(cl:in-package my_awesomme_code-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <WordCount-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WordCount-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_awesomme_code-srv:<WordCount-request> is deprecated: use my_awesomme_code-srv:WordCount-request instead.")))

(cl:ensure-generic-function 'words-val :lambda-list '(m))
(cl:defmethod words-val ((m <WordCount-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_awesomme_code-srv:words-val is deprecated.  Use my_awesomme_code-srv:words instead.")
  (words m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WordCount-request>)))
  ...
  "my_awesomme_code/WordCountRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WordCount-request)))
  "Returns string type for a service object of type 'WordCount-request"
  "my_awesomme_code/WordCountRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <WordCount-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WordCount-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_awesomme_code-srv:<WordCount-response> is deprecated: use my_awesomme_code-srv:WordCount-response instead.")))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <WordCount-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_awesomme_code-srv:count-val is deprecated.  Use my_awesomme_code-srv:count instead.")
  (count m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WordCount-response>)))
  ...
  "my_awesomme_code/WordCountResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WordCount-response)))
  "Returns string type for a service object of type 'WordCount-response"
  "my_awesomme_code/WordCountResponse")
